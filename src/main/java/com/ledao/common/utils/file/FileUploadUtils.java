...
import com.ledao.common.exception.file.FileNameLengthLimitExceededException;
...
public class FileUploadUtils
{
     ...
     * 默认上传的地址
     */
    private static String defaultBaseDir = LeDaoConfig.getProfile();
    ...
    public static final String upload(MultipartFile file) throws IOException
    {
        try
        {
            System.out.println("默认上传地址：===="+getDefaultBaseDir());
