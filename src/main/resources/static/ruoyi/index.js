...
$(function() {
    ...
    function menuItem() {
        ...
        $('.menuTab').each(function() {
            if ($(this).data('id') == dataUrl) {
                if (!$(this).hasClass('active')) {
                    ...
                    scrollToTab(this);
                    // 显示tab对应的内容区
                    $('.mainContent .LeDao_iframe').each(function() {
                        if ($(this).data('id') == dataUrl) {
        ...
        if (flag) {
            ...
            $('.mainContent').find('iframe.LeDao_iframe').hide().parents('.mainContent').append(str1);
    ...
    function closeOtherTabs() {
        $('.page-tabs-content').children("[data-id]").not(":first").not(".active").each(function() {
            $('.LeDao_iframe[data-id="' + $(this).data('id') + '"]').remove();
            $(this).remove();
        });
    ...
    function refreshTab() {
    	...
    	var target = $('.LeDao_iframe[data-id="' + currentId + '"]');
    ...
    $('.tabCloseAll').on('click', function() {
        ...
        $('.page-tabs-content').children("[data-id]:first").each(function() {
            $('.LeDao_iframe[data-id="' + $(this).data('id') + '"]').show();
